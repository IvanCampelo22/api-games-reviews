...
from app.api.endpoints.v1 import released_last_month_endpoints, released_last_month_plataform_endpoints, upcoming_games_endpoints, developers_endpoint, developers_wit_id_endpoint
