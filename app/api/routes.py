...
from app.api.endpoints.v1 import reviews_endpoint, games_endpoint
...
api_router.include_router(reviews_endpoint.router, prefix="/reviews", tags=['reviews'])
api_router.include_router(games_endpoint.router, prefix="/games", tags=['games'])
